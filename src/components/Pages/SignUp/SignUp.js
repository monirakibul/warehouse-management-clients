                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                        ...
                        <form onSubmit={handleCreateUser}>
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5 text-left">
                                    ...
                                    <div className="flex">
                                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><Icon path={mdiAccount} size="25px" className="text-gray-400"></Icon></div>
                                        <input name='name' type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Mr John" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5 text-left">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input name='email' type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3 text-left">
                                <div className="w-full px-3 mb-12">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input name='password' type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
                        ...
                        <button onClick={handleGoogleSignIn} className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                            <div className="relative flex items-center space-x-4 justify-center">
                                ...
                                <span className="block pl-3 w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Continue with Google</span>
                            </div>
                        </button>
                    </div>
                </div>
