                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5 text-left">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input name='name' type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-green-500" placeholder="Mr John" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5 text-left">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input name='email' type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-green-500" placeholder="johnsmith@example.com" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3 text-left">
                                <div className="w-full px-3 mb-12">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input name='password' type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-green-500" placeholder="************" />
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
