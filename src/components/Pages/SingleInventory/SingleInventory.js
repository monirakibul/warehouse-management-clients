...
const SingleInventory = (props) => {
    ...
    return (
        <div class="flex flex-col bg-white border border-gray-100 m-5 md:m-10 shadow-lg hover:shadow-xl rounded-lg">
            ...
            <div class="relative flex justify-between flex-grow items-start px-2 pt-2">
                ...
                <span className={`absolute -top-2 right-5 ${quantity > 0 ? 'bg-green-500' : 'bg-red-500'} rounded-lg px-2 text-xs text-white`}> {quantity == 0 ? 'Sold Out' : `In stock: ${quantity}`}</span>
            ...
            <div class="flex justify-between items-center px-2 pb-2 border-t border-gray-100">
                <div class="p-2 text-left">
                    ...
                    <div class="text-xs text-gray-500 font-poppins">Supplier: {supplier}</div>
                </div>
                <div class="p-2 w-1/2">
