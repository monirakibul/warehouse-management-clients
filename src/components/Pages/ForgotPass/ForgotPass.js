...
const ForgotPass = () => {
    ...
    useEffect(() => {
        if (getError) {
            toast(error?.message ? error.message : 'Reset email sent. check your email');
            setGetError(false) // prevent displaying double toast
        }
    }, [sending])
                ...
                <div className="md:flex w-full">
                    ...
                    <div className="w-full md:w-1/2 py-10 px-5 md:px-10 bg-white">
                        <div className="text-center mb-10">
                            <h1 className="text-green-500 text-2xl md:text-3xl lg:text-4xl font-bold p-4">RESET PASSWORD</h1>
                        ...
                        <form onSubmit={resendEmail}>
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    <button type='submit' className="block w-full max-w-xs mx-auto bg-green-500 hover:bg-green-700 focus:bg-green-700 text-white rounded-lg px-3 py-3 font-semibold">RESET NOW</button>
                                </div>
                            </div>
                        </form>
